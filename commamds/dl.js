 ...
 * This file is part of Royal and is licensed under the GNU GPLv3.
 * You may not use this file except in compliance with the License.
 * See the LICENSE file or https://www.gnu.org/licenses/gpl-3.0.html
 * -------------------------------------------------------------------------------
 */

const { MTRK, wtype, prefix, sleep, extractUrlsFromString, fb, ytaudio, config, ytvideo, xdl, tt, insta, mediaFire, rand, getBuffer } = require("../core")
...
MTRK({
        ...
        var cap = `🩵╔═══⟪ 𝗥𝗢𝗬𝗔𝗟 𝗣𝗟𝗔𝗬𝗘𝗥 ⟫═══╗
00:00 ───◁ㅤ ❚❚ ㅤ▷─── 05:00
🩵╚═════════════════════╝ ${ytsa.duration.timestamp} ♡`
        m.react("")
