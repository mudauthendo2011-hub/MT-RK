 ...
 * -------------------------------------------------------------------------------
 */
const {MTRK, webp2png, webp2mp4, elevenlabs, rand, getBuffer, toAudio, config, processAudio, extractUrlsFromString, toPTT, isMediaURL, wtype} = require("../core")
...
name: "roundstk|round",
  ...
  try {
    ...
    categories: ["🤩", "🎉"],
    id: "https://github.com/mudauthendo2011-hub/MT-RK",
    quality: 75,
    })
